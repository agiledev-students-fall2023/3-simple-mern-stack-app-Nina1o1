...
### My public link
This was a working link generated by ngrok. I replaced the command `ngrok http 4000` by `ngrok http 7002` to match the front-end path. I terminated my application in my computer, and this link is no longer valid.
```
https://ada2-216-165-95-179.ngrok-free.app/
```
